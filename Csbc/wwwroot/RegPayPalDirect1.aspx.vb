...
Public Class RegPayPalDirect
    ...
    Private Function CheckCoaches()
        ...
        Try
            ...
            'SQL = "SELECT count(*) as Coaches from People "
            'SQL = SQL & "where Parent = 1 AND Coach = 1 "
            'SQL = SQL & "AND MainHouseid = " & Session("HouseID")
        Catch ex As Exception
    ...
    Private Function CheckSponsors()
        ...
        Try
            ...
            If rsData.Rows(0).Item("Sponsors") > 0 Then CheckSponsors = True
    ...
    Private Function PayPalMessages(ByVal RtnError As String, ByVal Errmsg As String)
