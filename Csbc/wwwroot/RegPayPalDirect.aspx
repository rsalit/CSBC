								...
								<td vAlign="top" width="504" bgColor="#ffffff" height="100%">
									<DIV style="WIDTH: 768px; POSITION: relative; HEIGHT: 364px" ms_positioning="GridLayout">&nbsp;&nbsp;&nbsp;&nbsp;
										<asp:label id="lblTitle" style="Z-INDEX: 102; LEFT: 320px; POSITION: absolute; TOP: 8px" runat="server"
											...
											Height="24px"> Registration</asp:label><asp:label id="lblMSG" 
                                            style="Z-INDEX: 104; LEFT: 480px; POSITION: absolute; TOP: 335px; height: 27px;" runat="server"
											Font-Size="Small" ForeColor="Red" Font-Bold="True" Width="272px"></asp:label>&nbsp;&nbsp;
										<asp:button id="comPrev" 
                                            style="Z-INDEX: 105; LEFT: 648px; POSITION: absolute; TOP: 98px" tabIndex="16"
