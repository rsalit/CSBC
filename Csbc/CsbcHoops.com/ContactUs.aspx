<%@ Register TagPrefix="uc1" TagName="BoardInfoControl" Src="BoardInfoControl.ascx" %>
<%@ Page Language="VB" AutoEventWireup="false" Inherits="CSBCHOOPS_COM.ContactUs" Codebehind="ContactUs.aspx.vb" %>
			...
			<tr id="graybox">
				...
				<asp:Repeater ID="repBoard" runat="server">
												...
												<ItemTemplate>
													<tr>
														<td>
															<uc1:BoardInfoControl id="BoardInfo" runat="server"></uc1:BoardInfoControl>
														</td>
													</tr>
												</ItemTemplate>
												<FooterTemplate>
